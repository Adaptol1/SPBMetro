...
public class Main
{
    private static Logger loggerForStationSearching;
    private static Logger loggerForWrongStations;
    private static Logger loggerForErrors;
    ...
    {
        loggerForStationSearching = LogManager.getRootLogger();
        loggerForWrongStations = LogManager.getRootLogger();
        loggerForErrors = LogManager.getRootLogger();
        ...
        for(;;)
        {
            ...
            {
                loggerForErrors.error("Возникла ошибка: " + error);
            }
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                loggerForStationSearching.info("Выполнялся поиск станции: " + station);
                return station;
            }
            loggerForWrongStations.warn("Название станции введено неверно: " + line);
